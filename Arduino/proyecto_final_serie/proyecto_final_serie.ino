...
const int PASOS1A2 = 530;  // Pasos de motor entre la posicion 1 y la 2
const int PASOS2A3 = 530;  // Pasos de motor entre la posicion 2 y la 3
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    posicion_deseada = Serial.parseInt();
    Serial.println(posicion_deseada);
